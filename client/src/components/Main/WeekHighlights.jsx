    ...
    <>
      {width >= 768 ? (
        <div className="bg-gradient-to-t from-blue-800 via-blue-500 to-cyan-500 dark:from-darkColor1 dark:to-darkColor2 rounded-xl h-3/4 shadow-lg p-2 sm:p-4">
          <h1 className="text-center font-bold text-xl sm:text-2xl text-white mb-2 sm:mb-4">
            Week Highlights
          </h1>
          <div className="overflow-x-auto">
            <table className="table-auto w-full text-white">
              <thead>
                <tr>
                  <th className="text-left text-xs sm:text-sm md:text-lg">
                    Achievements
                  </th>
                  <th className="text-right text-xs sm:text-sm md:text-lg">
                    Details
                  </th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-white">
                  ...
                  <td className="md:py-1 sm:py-2 text-right">
                    {isAdmin ? "Achieved" : "NA"}
                  </td>
                </tr>
                <tr className="border-b border-white">
