    ...
    <div className="w-1/3 h-full bg-white dark:bg-slate-800 rounded-xl relative">
      ...
      <div className="md:pt-12 pt-4 md:pb-4 px-4">
        <div className="flex flex-col text-center mt-6">
          <span className="font-bold text-purple-700 dark:text-puple-800 text-sm md:text-xl">Daily Running</span>
          <span className="text-gray-500 dark:text-white text-sm md:text-base">10 km / week</span>
        </div>
