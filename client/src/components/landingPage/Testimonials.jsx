...
const Testimonials = ({ id }) => {
  const testimonials = [
    {
      content:
        "Joining Elevate Fitness has been one of the best decisions I've made for my health. The trainers are incredibly knowledgeable and supportive, guiding me through every step of my fitness journey. The sense of community here is unparalleled, with fellow members cheering each other on. Thanks to Elevate Fitness, I've achieved fitness goals I never thought possible.",
      imageSrc:
  ...
  return (
    <section id={id} className="bg-white rounded-xl dark:bg-slate-900">
      <div className="container px-6 py-10 mx-auto">
        ...
        <div className="flex items-start max-w-6xl mx-auto mt-16">
          ...
          >
            <FaLessThan className="dark:text-white"/>
          </button>
          ...
          >
            <FaGreaterThan className="dark:text-white"/>
          </button>
        </div>
      </div>
    </section>
